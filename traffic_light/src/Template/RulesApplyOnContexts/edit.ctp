<div class="actions columns large-2 medium-3">
	<h3><?= __('Actions') ?></h3>
	<ul class="side-nav">
		<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $rulesApplyOnContext->id], ['confirm' => __('Are you sure you want to delete # {0}?', $rulesApplyOnContext->id)]) ?></li>
...
<?= $this->Form->create($rulesApplyOnContext) ?>
	<fieldset>
		<legend><?= __('Edit Rules Apply On Context') ?></legend>
	<?php
